      ...
      <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
        ...
        <tr>
          ...
          <td class="text-nowrap">
            <button data-target="#addNew<?php echo $row['nip']; ?>" type="button" class="btn btn-xs btn-icon btn-round btn-success" data-toggle="modal" title="Tambah">
              <i class="icon md-thumb-up" aria-hidden="true"></i> Pilih
            </button>
